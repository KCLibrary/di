...
<div id="header-full">
  <header id="header">
  <div id="bg-logo" style="position:absolute; z-index:15px; right:200px;"><img src="<?php print path_to_theme(); ?>/images/di_background_icon.png" width="149" height="125" /></div>
    <div class="container">
      <?php if ($logo): ?>
